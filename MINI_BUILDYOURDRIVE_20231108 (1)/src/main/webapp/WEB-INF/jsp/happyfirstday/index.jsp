    ...
    <div id="wrapper">
		...
		<section id="container">
			...
			<div class="main_large_teaser">
                <div class="visual"><img src="/asset/images/content/mini_happy_visual_20220906.jpg" alt=""></div>
				<!-- <div class="txt_data">
					<div class="inner">
			...
			<section id="contents">
				...
				<div class="sub_copy">
					<div class="sub_copy_cell">
						<div class="sub_copy_data">
							<h3 class="sub_copy_title">HAPPY FIRST DAY.</h3>
							<h4 class="sub_copy_title2">MINI ORIGINAL ACCESSORIES &amp; LIFESTYLE.</h4>
							<!-- <p class="sub_copy_txt">오직, 신차 구매 고객분들께만 제공되는 단 한 번의 파워풀한 혜택.<br>다양한 MINI Original Accessories & Lifestyle 제품을  30% 할인된 가격으로 만나보실 수 있습니다.<br>신차 구매 후, 단 3개월만 제공되는 특별한 기회를 놓치지 마십시오.</p> -->
							<p class="sub_copy_txt">오직, MINI 구매 고객분들께만 제공되는 단 한 번의 파워풀한 혜택.<br>다양한 MINI Original Accessories & Lifestyle 제품을 30% 할인된 가격으로 만나보실 수 있습니다.<br>MINI 구매 후, 단 3개월만 제공되는 특별한 기회를 놓치지 마십시오.</p>
						</div>
					</div>
				</div>
					...
					<div class="benefit_info">
						<ol>
							<li>
								<div class="info_cell">
									<p class="step">혜택 1</p>
									<p class="txt">MINI Original Accessories &amp; Lifestyle 30% 할인.</p>
								</div>
							</li>
							<li>
								<div class="info_cell">
						...
						<div class="swiper-container">
							<div class="swiper-wrapper">
								...
								<div class="swiper-slide">
									<div class="swiper-slider-visual"><p class="txt" style="color:#fff;">MINI ORGINAL ACCESSORIES.</p><img src="/asset/images/content/suitup_slider_visual_01.jpg" alt=""></div>
								</div>	
				...
				<div class="default_cell swiper_content" data-slider-index="1">
					...
					<div class="con_title none">HAPPY FIRST DAY SIMULATION.</div>
									...
									<div class="hover_visual_content" data-index="0">
										...
										<div class="btns-wrap">
											<ul>
												...
												<li><a href="/asset/images/2021-2022%20MINI%20Lifestyel%20collection_low.pdf" target="_blank" class="button01">라이프스타일 카달로그 다운로드</a></li>
											</ul>
										</div>
									</div>
