		    ...
		    <li>
		        <div class="list__item__inner">                                                
		            <div>
		                ...
		                <div class="info_wrap <c:if test="${ result.optFlg eq 'Y' }">no_price</c:if>">
		                    ...
		                    <!-- 옵션 상품 -->
		                	<c:if test="${ result.optFlg eq 'Y' && fn:length(result.itemsOptList) > 0 }">
		                ...
		                <!-- 일반 상품  -->	 
		                <c:if test="${ result.optFlg eq 'N' }">
		                	<c:if test="${ result.saleFlg eq 'Y' }">
