    ...
    <div id="wrapper">
		...
		<section id="container">
			...
			<div class="main_large_teaser">
                <div class="visual" style="border-bottom-color:#7b7a76;"><img src="/asset/images/content/wcw_mini_key_visual230718.jpg" alt=""></div>
				<!--
				<div class="txt_data">
					<div class="inner">
								...
								<div class="txt_table">
									<ul> 
										...
										<li class="has-image-link">
											...
											WCW 장착 시,<br/>
											MINI Natural Air Starter Kit 제공<br class="mo_br"/><br class="mo_br"/>
