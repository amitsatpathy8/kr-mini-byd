...
public class KISA_SHA256 {
	...
	*/
	...
	public static String getEncCode(String setVal) throws UnsupportedEncodingException{
		String rtnVal = "";
		byte pbCipher[]   = new byte[32];

	    SHA256_Encrpyt(setVal.getBytes("UTF-8"),  setVal.length(), pbCipher);
	    
	    for (int i=0; i<32; i++){
	    	rtnVal = rtnVal+Integer.toHexString(0xff&pbCipher[i])+"";
	    }
	...
	{
		System.out.println(getEncCode("12345"));
	}
